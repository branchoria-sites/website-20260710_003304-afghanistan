...
header:
  ...
  preview_image: /assets/images/Morocco_32e087-overview-social.jpg
...
<button type="button" class="interactive-map-region-button" data-interactive-map-continent-focus="africa" aria-pressed="false" aria-label="Focus map on Africa"><span>Africa</span><small>53</small></button>
...
<h1 class="home-map-panel-title">Explore UFO reports worldwide</h1>
<p class="home-map-panel-note">Use the map to explore a country file, or browse the full country list.</p>
</header>
